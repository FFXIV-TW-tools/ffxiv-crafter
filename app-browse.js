...
(function () {
  ...
  // ⚠ **不可拿 `document.scrollHeight` 反推**：body 有 `min-height: 100vh`，內容短於一個螢幕時
  //   文件高度**恆等於視窗高、不隨內容縮**（2026-08-19 修 box-sizing 之前更慘：恆為 100vh+64，
  //   實測連按兩次表格就縮掉 140px，489→419→349）⇒ 反推出來的「下方佔用」會一路灌水。
  //   量 `<main>` 底緣才是內容真正的結束位置。
